 ...
 *   │                                             │
 *   │  READS:                                     │
 *   │    - StorageAcssRuleComponent (label field) │
 *   │                                             │
 *   │  WRITES:                                    │
 ...
 *   Label transitions validated against permission flags.
 *
...
// No helper functions needed → label transitions driven by API route handlers
...
void StorageWflwTranSystem::tick(ecs::Registry& /*registry*/, float /*dt*/) {
    // Label transitions driven by API route PROMOTE requests
}
