 ...
 *
 * @file        storage_file_writ_sys.hpp
 * @brief       StorageFileWritSystem - Filesystem CRUD operations
 * @description Processes granted access requests by reading/writing/deleting files
 *
 * @module      ase-storage
 * @layer       3 (Modules)
 * @category    process
...
public:
    const char* name() const override { return "StorageFileWritSystem"; }
