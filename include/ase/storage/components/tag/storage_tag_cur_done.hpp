 ...
 * =============================================================================
 *
 * @file        storage_tag_cur_done.hpp
 * @brief       StorageCurDoneTag - Curator request processed
 * @description Marks a request entity as completed for deferred cleanup
 *
 * @module      ase-storage
 * @layer       3 (Module)
 * @category    tag
...
/**
 * @brief StorageCurDoneTag - Request entity processed (deferred deletion)
 *
 * State: StorageCurPrcSystem has completed this request
 * Filter: Cleanup pass destroys entities with this tag
 * Added: StorageCurPrcSystem after processing request
 * Removed: Entity is destroyed in cleanup pass
 */
struct StorageCurDoneTag {};
