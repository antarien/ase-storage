 ...
 * =============================================================================
 *
 * @file        storage_tag_audt_pend.hpp
 * @brief       StorageAudtPendTag - Audit entry not yet persisted to MongoDB
 * @description Marker for audit entities that need batch-write to database
 *
 * @module      ase-storage
 * @layer       3 (Module)
 * @category    tag
...
/**
 * @brief StorageAudtPendTag - Audit entry needs database persistence
 *
 * State: Access decision recorded but not yet written to MongoDB
 * Filter: Used by StgAudtWrtSystem to batch-write entries at 1Hz
 * Added: StgAcssChkSystem after every access decision
 * Removed: StgAudtWrtSystem after successful MongoDB write
 */
struct StorageAudtPendTag {};
