 ...
 * =============================================================================
 *
 * @file        storage_tag_cur_req.hpp
 * @brief       StorageCurReqTag - Pending curator request
 * @description Marks an entity with StorageReqCurComponent as unprocessed
 *
 * @module      ase-storage
 * @layer       3 (Module)
 * @category    tag
...
/**
 * @brief StorageCurReqTag - Curator request pending processing
 *
 * State: HTTP handler created a request entity waiting for StorageCurPrcSystem
 * Filter: StorageCurPrcSystem views StorageReqCurComponent + StorageCurReqTag
 * Added: curator_routes.cpp when creating request entity
 * Removed: StorageCurPrcSystem after processing (replaced by StorageCurDoneTag)
 */
struct StorageCurReqTag {};
