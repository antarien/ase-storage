 ...
 * =============================================================================
 *
 * @file        storage_tag_relm_org.hpp
 * @brief       StorageRelmOrgTag - Realm is an organization workspace
 * @description Type tag for realms created as studio or team workspaces
 *
 * @module      ase-storage
 * @layer       3 (Module)
 * @category    tag
...
/**
 * @brief StorageRelmOrgTag - Realm is an organization (studio/team)
 *
 * State: Realm was created by an owner as a shared workspace
 * Filter: registry.view<StorageStaRelmComponent, StorageRelmOrgTag>()
 * Added: Realm creation route when type=organization
 * Removed: Never (realm type is immutable)
 */
struct StorageRelmOrgTag {};
