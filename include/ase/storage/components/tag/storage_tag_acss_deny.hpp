 ...
 * =============================================================================
 *
 * @file        storage_tag_acss_deny.hpp
 * @brief       StorageAcssDenyTag - Access request was denied by A/ACS
 * @description Marker for request entities that failed an ACL check step
 *
 * @module      ase-storage
 * @layer       3 (Module)
 * @category    tag
...
/**
 * @brief StorageAcssDenyTag - A/ACS access check failed
 *
 * State: Request entity failed clearance, codeword, permission, or quota check
 * Filter: Used by HTTP route handlers to return 403 with audit reason
 * Added: StgAcssChkSystem when any of the 10 check steps fails
 * Removed: Entity destroyed after HTTP response sent
 */
struct StorageAcssDenyTag {};
