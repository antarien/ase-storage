 ...
 * =============================================================================
 *
 * @file        storage_tag_vot_pend.hpp
 * @brief       StorageVotPendTag - Vote of Confidence is collecting ballots
 * @description Marker for vote entities that are actively collecting ballots
 *
 * @module      ase-storage
 * @layer       3 (Module)
 * @category    tag
...
/**
 * @brief StorageVotPendTag - Vote of Confidence actively collecting ballots
 *
