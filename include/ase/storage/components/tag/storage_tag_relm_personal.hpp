 ...
 * =============================================================================
 *
 * @file        storage_tag_relm_personal.hpp
 * @brief       StorageRelmPersonalTag - Realm is a personal user workspace
 * @description Type tag for realms auto-created per registered user
 *
 * @module      ase-storage
 * @layer       3 (Module)
 * @category    tag
...
/**
 * @brief StorageRelmPersonalTag - Realm is a personal workspace
 *
 * State: Realm was auto-created when user registered
 * Filter: registry.view<StorageStaRelmComponent, StorageRelmPersonalTag>()
 * Added: StgIniSystem or realm creation route
 * Removed: Never (realm type is immutable)
 */
struct StorageRelmPersonalTag {};
