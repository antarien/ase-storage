 ...
 * =============================================================================
 *
 * @file        storage_tag_kycd_rev.hpp
 * @brief       StorageKycdRevTag - Keycard was revoked by issuer or admin
 * @description Marker for entities whose keycard was explicitly revoked
 *
 * @module      ase-storage
 * @layer       3 (Module)
 * @category    tag
...
/**
 * @brief StorageKycdRevTag - Keycard revoked (manually invalidated)
 *
 * State: Issuer or admin explicitly revoked this keycard
 * Filter: Used by StgAcssChkSystem to deny revoked keycards
 * Added: StgKycdRevSystem when revocation detected
 * Removed: Entity destroyed during cleanup
 */
struct StorageKycdRevTag {};
