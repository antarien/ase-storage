 ...
 * =============================================================================
 *
 * @file        storage_tag_cur_unrated.hpp
 * @brief       StorageCurUnratedTag - Curation entry not yet reviewed
 * @description Default state for new curation entries awaiting curator review
 *
 * @module      ase-storage
 * @layer       3 (Module)
 * @category    tag
...
/**
 * @brief StorageCurUnratedTag - Curation not yet reviewed
 *
 * State: Default for new curation entries
 * Filter: Used by StorageCurPrcSystem to detect unreviewed images
 * Added: When curation entity is first created
 * Removed: When curator sets status to approved, rejected, or rework
 */
struct StorageCurUnratedTag {};
