 ...
 * =============================================================================
 *
 * @file        storage_tag_kycd_exp.hpp
 * @brief       StorageKycdExpTag - Keycard has expired
 * @description Marker for entities whose keycard lifetime has elapsed
 *
 * @module      ase-storage
 * @layer       3 (Module)
 * @category    tag
...
/**
 * @brief StorageKycdExpTag - Keycard has expired (wall clock past expires_at)
 *
 * State: Keycard lifetime elapsed, access must be denied
 * Filter: Used by StgAcssChkSystem to reject expired keycards
 * Added: StgKycdExpSystem when wall clock exceeds expires_at
 * Removed: Entity destroyed during cleanup
 */
struct StorageKycdExpTag {};
