 ...
 * =============================================================================
 *
 * @file        storage_tag_cur_rejected.hpp
 * @brief       StorageCurRejectedTag - Curation entry rejected
 * @description Curator has rejected this image as not suitable
 *
 * @module      ase-storage
 * @layer       3 (Module)
 * @category    tag
...
/**
 * @brief StorageCurRejectedTag - Image rejected by curator
 *
 * State: Not suitable for intended purpose
 * Filter: Used by StorageCurPrcSystem when status changes
 * Added: StorageCurPrcSystem on CUR_ACT_STATUS with CUR_ST_REJECTED
 * Removed: When status changes to another state
 */
struct StorageCurRejectedTag {};
