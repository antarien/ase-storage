 ...
 * =============================================================================
 *
 * @file        storage_tag_acss_grant.hpp
 * @brief       StorageAcssGrantTag - Access request was granted by A/ACS
 * @description Marker for request entities that passed all 10 ACL checks
 *
 * @module      ase-storage
 * @layer       3 (Module)
 * @category    tag
...
/**
 * @brief StorageAcssGrantTag - A/ACS access check passed
 *
 * State: Request entity passed all 10 Mandatory Access Control steps
 * Filter: Used by StgFsWrtSystem to process granted file operations
 * Added: StgAcssChkSystem after successful clearance+codeword+permission check
 * Removed: Entity destroyed after file operation completes
 */
struct StorageAcssGrantTag {};
