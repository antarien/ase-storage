 ...
 * =============================================================================
 *
 * @file        storage_tag_kycd_rjct.hpp
 * @brief       StorageKycdRjctTag - Keycard signature verification failed
 * @description Marker for entities whose keycard HMAC-SHA256 check failed
 *
 * @module      ase-storage
 * @layer       3 (Module)
 * @category    tag
...
/**
 * @brief StorageKycdRjctTag - Keycard rejected (invalid HMAC-SHA256 signature)
 *
 * State: Keycard failed cryptographic verification
 * Filter: Used by cleanup systems to destroy rejected entities
 * Added: StgKycdVldSystem when signature check fails
 * Removed: Entity destroyed during cleanup
 */
struct StorageKycdRjctTag {};
