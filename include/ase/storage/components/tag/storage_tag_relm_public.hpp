 ...
 * =============================================================================
 *
 * @file        storage_tag_relm_public.hpp
 * @brief       StorageRelmPublicTag - Realm is the platform-wide public realm
 * @description Type tag for the engine defaults and shared templates realm
 *
 * @module      ase-storage
 * @layer       3 (Module)
 * @category    tag
...
/**
 * @brief StorageRelmPublicTag - Public platform realm (engine defaults)
 *
 * State: Single realm with shared templates, shaders, and engine assets
 * Filter: registry.view<StorageStaRelmComponent, StorageRelmPublicTag>()
 * Added: StgIniSystem during bootstrap (exactly one)
 * Removed: Never (public realm is permanent)
 */
struct StorageRelmPublicTag {};
