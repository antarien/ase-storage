 ...
 * =============================================================================
 *
 * @file        storage_tag_cur_rework.hpp
 * @brief       StorageCurReworkTag - Curation entry needs rework
 * @description Curator flagged this image as needing changes before approval
 *
 * @module      ase-storage
 * @layer       3 (Module)
 * @category    tag
...
/**
 * @brief StorageCurReworkTag - Image needs changes before approval
 *
 * State: Curator reviewed but requires modifications
 * Filter: Used by StorageCurPrcSystem when status changes
 * Added: StorageCurPrcSystem on CUR_ACT_STATUS with CUR_ST_NEEDS_REWORK
 * Removed: When status changes to another state
 */
struct StorageCurReworkTag {};
