 ...
 * =============================================================================
 *
 * @file        storage_tag_kycd_vld.hpp
 * @brief       StorageKycdVldTag - Keycard validated and active
 * @description Marker for entities with a valid, non-expired keycard
 *
 * @module      ase-storage
 * @layer       3 (Module)
 * @category    tag
...
/**
 * @brief StorageKycdVldTag - Keycard is validated and not expired
 *
 * State: Client entity passed keycard HMAC-SHA256 verification
 * Filter: Used by StgAcssChkSystem and all downstream access checks
 * Added: StgKycdVldSystem after successful keycard verification
 * Removed: StgKycdExpSystem when keycard expires
 */
struct StorageKycdVldTag {};
