 ...
 * =============================================================================
 *
 * @file        storage_tag_cur_approved.hpp
 * @brief       StorageCurApprovedTag - Curation entry approved for use
 * @description Curator has approved this image for use in the game
 *
 * @module      ase-storage
 * @layer       3 (Module)
 * @category    tag
...
/**
 * @brief StorageCurApprovedTag - Image approved for game use
 *
 * State: Curator reviewed and approved this image
 * Filter: Used by StorageCurPrcSystem when status changes
 * Added: StorageCurPrcSystem on CUR_ACT_STATUS with CUR_ST_APPROVED
 * Removed: When status changes to another state
 */
struct StorageCurApprovedTag {};
