 ...
 * =============================================================================
 *
 * @file        storage_tag_relm_conceal.hpp
 * @brief       StorageRelmConcealTag - Realm hidden from non-members
 * @description Concealment tag per DSGN_109 principle: existence not visible
 *
 * @module      ase-storage
 * @layer       3 (Module)
 * @category    tag
...
/**
 * @brief StorageRelmConcealTag - Realm existence hidden from non-members
 *
 * State: Non-members get "not_found" instead of "access_denied" (no info leak)
 * Filter: StgCncFltSystem uses this to filter realm listing responses
 * Added: StgIniSystem on org/personal realm creation (default concealment)
 * Removed: Realm owner explicitly disables concealment
 */
struct StorageRelmConcealTag {};
