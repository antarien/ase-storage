 ...
 * =============================================================================
 *
 * @file        storage_tag_mgr.hpp
 * @brief       StorageMgrTag - Singleton manager entity marker
 * @description Marks the single manager entity for the storage module
 *
 * @module      ase-storage
 * @layer       3 (Module)
 * @category    tag
...
/**
 * @brief StorageMgrTag - Singleton manager entity for ase-storage module
 *
 * State: One entity per registry holds StorageResourceManager reference
 * Filter: Used by all storage systems to locate the manager
 * Added: StgIniSystem during Initialization
 * Removed: Never (lives for entire application lifetime)
 */
struct StorageMgrTag {};
