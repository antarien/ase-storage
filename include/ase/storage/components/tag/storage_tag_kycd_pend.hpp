 ...
 * =============================================================================
 *
 * @file        storage_tag_kycd_pend.hpp
 * @brief       StorageKycdPendTag - Keycard drained, not yet validated
 * @description Marker for entities whose keycard was drained from buffer
 *
 * @module      ase-storage
 * @layer       3 (Module)
 * @category    tag
...
/**
 * @brief StorageKycdPendTag - Keycard token drained, validation required
 *
 * State: Raw keycard token was drained from network buffer into entity
 * Filter: Used by StgKycdVldSystem to find tokens needing verification
 * Added: StgKycdDrnSystem after draining from StorageResourceManager
 * Removed: StgKycdVldSystem replaces with StorageKycdVldTag or StorageKycdRjctTag
 */
struct StorageKycdPendTag {};
